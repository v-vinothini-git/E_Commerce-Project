...
function updateCart()
{
    ...
    let productsList = document.querySelector('.cart_products_list');
    ...
    <div class="product_info">
        <div class="general_info">
          <div class="product_name">${item.productName}</div>
            <div class="ratings">
              <div class="stars">
                <img src="/icons/rating.jpg" class="star" />
                <img src="/icons/rating.jpg" class="star" />
                <img src="/icons/rating.jpg" class="star" />
                <img src="/icons/rating.jpg" class="star" />
                <img src="/icons/rating.jpg" class="star" />
              ...
              (${item.ratings}<i class="fa-regular fa-user"></i>)
              </div>
            </div>
        ...
        <button class="remove_btn" onclick="removeProduct(this)">Remove</button>
    </div>
    `;
